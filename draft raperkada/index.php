        ...
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    ...
                    if ($date_publish < $date) {
                        ...
                        <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?= $link3; ?>/t.html"
                           class="<?= $bool_hidden ?> btn btn-primary">
                            <!--ASLII-->
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a
                                                ...
                                                data-toggle="modal" title="Lihat Details?"
                                        ...
                                        <?php if ($_SESSION['level'] != "perancang") {
                                            ...
                                            <a href=""
                                                ...
                                                <?php } ?>
                                                    ...
                                                    data-toggle="modal" title="Hapus Data <?= $this->session->userdata('level');?>?"
			...
			" id="kirimWa" name="kirimWa" target="_blank">
                                ...
                                <div class="modal fade"
                                     id="delete_confirm<?php echo hashids_encrypt($baris->id_draft_permohonan); ?>">
                                                    ...
                                                    <div class="form-group col-lg-12"
                                                        ...
                                                        <div class="row m-l-1" style=" overflow: hidden;  ">
                                                            <?php if ($baris->lamp_surat_permohonan == null || $baris->lamp_surat_permohonan == "") {
                                                                ...
                                                                <label for="label" class="label"
                                                                       style="background-color: red">Tidak
                                                                    Dilampirkan</label>
                                                                <?php
                                                            } else { ?>
